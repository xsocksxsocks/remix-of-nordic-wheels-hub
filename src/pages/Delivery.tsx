  ...
  return (
    <Layout>
      ...
      <section className="section-padding">
        <div className="container">
          <h2 className="text-3xl font-serif font-bold mb-8">Vorbereitung der Lieferung und Übergabe</h2>
      ...
      <section className="section-padding bg-muted">
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="bg-card rounded-lg aspect-video flex items-center justify-center shadow-medium">
              <Truck className="h-24 w-24 text-muted-foreground/30" />
            </div>
            <div>
              <h2 className="text-3xl font-serif font-bold mb-6">Was ist die Übergabe?</h2>
      ...
      <section className="section-padding">
        <div className="container">
          <h2 className="text-3xl font-serif font-bold text-center mb-12">Lieferoptionen</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="p-8 bg-card rounded-lg border shadow-soft">
              ...
              <h3 className="text-xl font-serif font-bold mb-2">Lieferung nach Hause</h3>
              <p className="text-muted-foreground mb-4">
                Wir liefern das Fahrzeug direkt an Ihre Adresse. Einer unserer Experten nimmt die Übergabe vor.
              </p>
              <div className="text-lg font-semibold text-accent">Ab €99 je nach Entfernung</div>
            </div>
            ...
            <div className="p-8 bg-card rounded-lg border shadow-soft">
              ...
              <h3 className="text-xl font-serif font-bold mb-2">Abholung vor Ort</h3>
              <p className="text-muted-foreground mb-4">
                Holen Sie Ihr Fahrzeug bei uns in Hamburg ab. Wir führen die Übergabe vor Ort durch.
              </p>
              <div className="text-lg font-semibold text-accent">Kostenlos</div>
            </div>
          </div>
        </div>
      </section>
